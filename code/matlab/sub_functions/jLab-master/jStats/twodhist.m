...
if ~isempty(xdata)
    if strcmpi(parstr(1:3),'ser')
        [mat,binX,binY]=twodhist_one(xdata,ydata,xbin,ybin,str);
...
function[mat,binX,binY]=twodhist_one(xdata,ydata,xbin,ybin,str)

if strcmpi(str(1:3),'his')
    [mat,~,~,binX,binY]=histcounts2(xdata,ydata,xbin,ybin);
    mat = mat.';
